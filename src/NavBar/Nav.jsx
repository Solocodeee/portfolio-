          ...
          <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul className="navbar-nav">
              <li className="nav-item">
                <Link to="home" smooth={true} duration={500} offset={-70} className="nav-link text-white">
                  Home
                </Link>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
              <Link to="contact-form" smooth={true} duration={500} offset={-160} className="nav-link text-white">
                Contact
              </Link>
              </li>
            </ul>
